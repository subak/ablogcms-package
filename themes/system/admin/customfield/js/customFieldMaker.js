$(function(){
	...
	var generator = new Moon.View({
		...
		method:{
			...
			refresh:function(){
				this.removeData(["title","name","path","normalSize","imagename","tiny","tinySize","large","largeSize","square","squareSize","alt","openValidator","openConverter","converter","alert","groupAlert"]);
				this.data.type = "text";
				this.data.option = [{value:"",label:""}];
				this.data.validator = [{option:"",value:"",message:""}];
